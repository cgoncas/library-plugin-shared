...
package com.sample.library.service.base;

import com.sample.library.service.BookLocalServiceUtil;
...
public class BookLocalServiceClpInvoker {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName0.equals(name) &&
			...
			return BookLocalServiceUtil.addBook((com.sample.library.model.Book)arguments[0]);
		}
		...
		if (_methodName3.equals(name) &&
			...
			return BookLocalServiceUtil.deleteBook((com.sample.library.model.Book)arguments[0]);
		}
		...
		if (_methodName15.equals(name) &&
			...
			return BookLocalServiceUtil.updateBook((com.sample.library.model.Book)arguments[0]);
		}
