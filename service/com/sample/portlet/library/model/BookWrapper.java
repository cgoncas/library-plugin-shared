...
public class BookWrapper implements Book, ModelWrapper<Book> {
	...
	*/
	...
	@Override
	public int compareTo(com.sample.portlet.library.model.Book book) {
	...
	@Override
	public com.liferay.portal.model.CacheModel<com.sample.portlet.library.model.Book> toCacheModel() {
		return _book.toCacheModel();
	}

	@Override
	public com.sample.portlet.library.model.Book toEscapedModel() {
		return new BookWrapper(_book.toEscapedModel());
	}

	@Override
	public com.sample.portlet.library.model.Book toUnescapedModel() {
