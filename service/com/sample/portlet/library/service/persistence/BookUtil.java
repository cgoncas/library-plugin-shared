...
public class BookUtil {
	...
	* @param book the book
	*/
	public static void cacheResult(com.sample.portlet.library.model.Book book) {
	...
	*/
	public static void cacheResult(
		java.util.List<com.sample.portlet.library.model.Book> books) {
	...
	* @return the new book
	*/
	public static com.sample.portlet.library.model.Book create(long bookId) {
	...
	* @throws com.sample.portlet.library.NoSuchBookException if a book with the primary key could not be found
	* @throws SystemException if a system exception occurred
	*/
	public static com.sample.portlet.library.model.Book remove(long bookId)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.sample.portlet.library.NoSuchBookException {
		return getPersistence().remove(bookId);
	}

	public static com.sample.portlet.library.model.Book updateImpl(
	...
	/**
	* Returns the book with the primary key or throws a {@link com.sample.portlet.library.NoSuchBookException} if it could not be found.
	*
	* @param bookId the primary key of the book
	* @return the book
	* @throws com.sample.portlet.library.NoSuchBookException if a book with the primary key could not be found
	* @throws SystemException if a system exception occurred
	*/
	public static com.sample.portlet.library.model.Book findByPrimaryKey(
		long bookId)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.sample.portlet.library.NoSuchBookException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.sample.portlet.library.model.Book fetchByPrimaryKey(
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.sample.portlet.library.model.Book> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static BookPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (BookPersistence)PortletBeanLocatorUtil.locate(com.sample.portlet.library.service.ClpSerializer.getServletContextName(),
