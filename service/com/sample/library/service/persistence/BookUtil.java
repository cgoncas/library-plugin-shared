...
package com.sample.library.service.persistence;
...
public class BookUtil {
	...
	* @param book the book
	*/
	public static void cacheResult(com.sample.library.model.Book book) {
	...
	*/
	public static void cacheResult(
		java.util.List<com.sample.library.model.Book> books) {
	...
	* @return the new book
	*/
	public static com.sample.library.model.Book create(long bookId) {
	...
	* @throws com.sample.library.NoSuchBookException if a book with the primary key could not be found
	* @throws SystemException if a system exception occurred
	*/
	public static com.sample.library.model.Book remove(long bookId)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.sample.library.NoSuchBookException {
		return getPersistence().remove(bookId);
	}

	public static com.sample.library.model.Book updateImpl(
		com.sample.library.model.Book book)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(book);
	}

	/**
	* Returns the book with the primary key or throws a {@link com.sample.library.NoSuchBookException} if it could not be found.
	*
	* @param bookId the primary key of the book
	* @return the book
	* @throws com.sample.library.NoSuchBookException if a book with the primary key could not be found
	* @throws SystemException if a system exception occurred
	*/
	public static com.sample.library.model.Book findByPrimaryKey(long bookId)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.sample.library.NoSuchBookException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.sample.library.model.Book fetchByPrimaryKey(long bookId)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.sample.library.model.Book> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static BookPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (BookPersistence)PortletBeanLocatorUtil.locate(com.sample.library.service.ClpSerializer.getServletContextName(),
